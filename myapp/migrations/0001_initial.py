    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(default=b'O', max_length=2, null=True, blank=True, choices=[(b'O', b'order_recieved'), (b'A', b'Alloted'), (b'P', b'picked up'), (b'Pa', b'packed'), (b'C', b'completed'), (b'D', b'delivered'), (b'N', b'cancelled'), (b'F', b'fake'), (b'Q', b'query')])),
                ...
                ('pb', models.ForeignKey(blank=True, to='pickupboyapp.PBUser', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drop_phone', models.CharField(blank=True, max_length=16, null=True, validators=[django.core.validators.RegexValidator(regex=b'^[0-9]{10,11}$', message=b"Phone number must be entered in the format: '999999999'. And be of 10 digits.")])),
                ('status', models.CharField(default=b'P', max_length=2, null=True, blank=True, choices=[(b'P', b'pending'), (b'C', b'complete'), (b'PU', b'pickedup'), (b'CA', b'cancelled')])),
        ...
        migrations.CreateModel(
            name='Zipcode',
            fields=[
                ('pincode', models.CharField(max_length=6, serialize=False, primary_key=True)),
