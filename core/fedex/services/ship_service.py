...
class FedexProcessShipmentRequest(FedexBaseService):
    ...
    def _prepare_wsdl_objects(self):
        ...
        # SpecialServicesRequested = self.client.factory.create('PackageSpecialServicesRequested')
        # self.RequestedShipment.SpecialServicesRequested = SpecialServicesRequested
